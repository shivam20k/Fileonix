  ...
  return (
    <footer className='mt-20'>
      <div className='custom-screen'>
        <div className='mt-10 py-8 border-t border-gray-200 dark:border-gray-800 items-center justify-between sm:flex'>
          <p className='text-gray-500 dark:text-gray-400 text-center'>© 2023 FILEONIX Inc. All rights reserved.</p>
          <div className='flex items-center justify-center gap-x-6 text-gray-500 mt-6 sm:mt-0'>
            <a href='/' target='_blank' aria-label='social media'>
              <svg className='w-6 h-6 hover:text-gray-700 dark:hover:text-gray-200 duration-150' fill='none' viewBox='0 0 48 48'>
                <g clipPath='url(#a)'>
